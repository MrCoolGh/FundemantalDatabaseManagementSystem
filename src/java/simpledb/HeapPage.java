...
public class HeapPage implements Page {
    ...
    TransactionId dirtyTransaction = null;
    ...
    */
    ...
    public void deleteTuple(Tuple t) throws DbException {
        ...
        if ((this.tuples.length - this.getNumEmptySlots()) == 0) {
            throw new DbException("Page is empty");
        } else {
            if (this.getId().getPageNumber() != t.getRecordId().getPageId().getPageNumber()) {
                throw new DbException("Tuple not exist in this page");
            } else {
    ...
    public void insertTuple(Tuple t) throws DbException {
        ...
        } else if (this.getNumEmptySlots() == 0) {
            throw new DbException("Page is Full");
        } else {
            int i = 0;
            while(this.isSlotUsed(i)) {
                i++;
            }
    ...
    public boolean isSlotUsed(int i) {
        // some code goes here
        int byteArrIndex = (int)Math.floor(i / 8.0);
        int bitMask = 1 << (i - 8 * byteArrIndex);
        int slotBit = (bitMask & this.header[byteArrIndex]) >> i - 8 * byteArrIndex;
        return slotBit > 0;
    }
    ...
    private void markSlotUsed(int i, boolean value) {
        ...
        int bitMask = 1 << (i - 8 * byteArrIndex);
        if (value) {
            this.header[byteArrIndex] = (byte) (this.header[byteArrIndex] | bitMask);
        } else {
            this.header[byteArrIndex] = (byte) (this.header[byteArrIndex] & (~bitMask));
        }
    }
    ...
    public void updataLastAccessTime() {
